...
// @generated-id: b5bdaee6b3ef

package cloudsmith

// Generated from OpenAPI doc version 1.1185.2 (v2) and generator version 2.887.0
...
func New(opts ...SDKOption) *Cloudsmith {
	sdk := &Cloudsmith{
		SDKVersion: "1.1.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.5 2.887.0 1.1185.2 (v2) github.com/cloudsmith-io/cloudsmith-go-v2",
