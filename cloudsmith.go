...
// Generated from OpenAPI doc version 1.1185.1 (v2) and generator version 2.887.0
...
func New(opts ...SDKOption) *Cloudsmith {
	sdk := &Cloudsmith{
		SDKVersion: "1.1.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.4 2.887.0 1.1185.1 (v2) github.com/cloudsmith-io/cloudsmith-go-v2",
