...
func initHooks(h *Hooks) {
	...
	// Apply CLOUDSMITH_API_HOST / CLOUDSMITH_API_KEY env-var defaults.
	h.registerSDKInitHook(envConfigHook{})

	// Copy X-Pagination-Pagetotal into a synthetic body field so
	// x-speakeasy-pagination can read it.
	h.registerAfterSuccessHook(pagetotalHook{})
}
